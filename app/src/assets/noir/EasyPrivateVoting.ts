...
import EasyPrivateVotingContractArtifactJson from '../../target/circuit-EasyPrivateVoting.json' assert { type: 'json' };
...
export class EasyPrivateVotingContract extends ContractBase {
  ...
  public static deployWithOpts<
    M extends keyof EasyPrivateVotingContract['methods'],
  >(
